...
This page hosts **installer downloads** for NaruBase™ FlowReach — a
Windows desktop app for local-business lead research. Source code is
private; see [Releases](https://github.com/louisbyun/narubase-install/releases?q=flowreach) for the latest installer.
...
and questions: open an [issue](https://github.com/louisbyun/narubase-install/issues).
